...
const GroupStatusListBoxElement = (props) => {
    ...
    return (
        <Listbox value={selectedItem} onChange={handleSelect} className="relative" as="div">
            ...
            <Listbox.Options className="border overflow-hidden dark:border-white/10 divide-y dark:divide-white/10 absolute w-full bg-background-light dark:bg-background-dark rounded-md gap-2">
