  ...
  return (
    ...
    >
      <Transition
        ...
        enterFrom="opacity-0 translate-y-20 sm:translate-y-0 sm:scale-0 duration-[200ms]"
        enterTo="opacity-100 translate-y-0 sm:scale-100 duration-[200ms]"
        leave="transform duration-[200ms] transition ease-in-out"
        leaveFrom="opacity-100 sm:scale-100 duration-[200ms]"
        leaveTo="opacity-0 sm:scale-0 duration-[200ms]"
      >
